...
| Platform | File | Link |
|---|---|---|
| macOS (Apple Silicon, arm64) | `MiSTer Companion-3.9.2.dmg` | **[Download v3.9.2](https://github.com/ENFStudios/mister-companion-macos/releases/download/v3.9.2/MiSTer.Companion-3.9.2.dmg)** |
